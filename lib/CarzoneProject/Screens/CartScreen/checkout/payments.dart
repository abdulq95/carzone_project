...
import 'package:carzoneproject/CarzoneProject/Screens/CartScreen/checkout/summary.dart';
        ...
        child:Padding(padding: EdgeInsets.only(left: 16.0,right: 16.0),
            child:Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image(image: AssetImage("paypal.png"),color: Color(0xffBEBEBE),width: 50,height: 50,)
                        ],
                      ),
                    ),
                    Container(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.account_balance_wallet_outlined,color: Color(0xffBEBEBE),)
                ...
                Text("Name on Card",style: TextStyle(color: Colors.grey,fontSize: 15),),
                ...
                Text("Card Number",style: TextStyle(color: Colors.grey,fontSize: 15),),
                  ...
                  child:TextField(
                    ...
                    decoration: InputDecoration(
                      focusedBorder: UnderlineInputBorder(
                        ...
                        suffix: Image(image: AssetImage('mastercard.png'),width: 40,height: 40,)
               ...
               SizedBox(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("Expiry Date",style: TextStyle(color: Colors.grey,fontSize: 15),),
                    SizedBox(
                      width: MediaQuery.of(context).size.width*0.3,
                    ),
                    Text("CVV",style: TextStyle(color: Colors.grey,fontSize: 15),),
                ...
                Row(
                  children: [
                    ...
                    Text("Save this card details",style: TextStyle(
                      color: Colors.black,
                      fontSize: 15,
